        ...
        <div>
            ...
            <div className="content">
                ...
                <p className="grey fontNormal philosophie">
                    ...
                    <br /><br />
                    Genau hier wird das Neuunternehmen #HARTWORK ansetzen. Es soll ein Unternehmen für Kunden und Patienten werden, die genau das suchen. Ein Zentrum, dass nicht nur das Oberflächliche sieht, sondern sich auf das Wichtigste fokussiert. Im menschlichen Körper ist das Zentrum, das „Core“. Core (Lateinisch) heißt übersetzt „das Kernstück“. Hier ist das Innere gemeint und nicht nur die Oberfläche, die jeder sieht.
                    <br />
                    Core ist für die Rumpfstabilität im Körper zuständig. Hier kommt es zum Zusammenspiel verschiede- ner Muskelketten, die für die notwendige Stabilität sorgen. Ohne die Stabilität des Rumpfes geht es nicht. #HARTWORK möchte, dass Patienten und Kunden ihre Mitte finden und so eine aktivere und körperbewusstere Lebensweise verwirklichen können.
                    <br /><br />
